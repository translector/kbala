...
To use these stylesheets, rename the files and proyecto with the name of your theme.
...
proyecto-alpha-default-narrow.css  
...
proyecto-alpha-default-normal.css
...
proyecto-alpha-default-wide.css
